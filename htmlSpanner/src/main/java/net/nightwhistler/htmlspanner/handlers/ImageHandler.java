...
import net.nightwhistler.htmlspanner.spans.VerticalImageSpan;
...
public class ImageHandler extends TagNodeHandler {
	...
	public void handleTagNode(TagNode node, SpannableStringBuilder builder,
		...
		if (bitmap != null) {
			...
			drawable.setBounds(0, 0, bitmap.getWidth()*2 - 1,
					bitmap.getHeight()*2 - 1);
			
            //stack.pushSpan( new ImageSpan(drawable), start, builder.length() );
			stack.pushSpan( new VerticalImageSpan(drawable), start, builder.length() );
		}
	}
